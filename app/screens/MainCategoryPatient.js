...
import styles from '../styles/MainCategoryPatientStyle';

const MainCategoryPatient = () => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Continue Tests', { screen: 'Physical Checklist Patient', category: 'Physical' })}
      >
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Continue Tests', { screen: 'Cognitive Checklist Patient', category: 'Cognitive' })}
      >
        <Text style={styles.buttonText}>Thinking or remembering</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Continue Tests', { screen: 'Emotional Checklist Patient', category: 'Emotional' })}
      >
        <Text style={styles.buttonText}>Social or emotional</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('Continue Tests', { screen: 'Sleep Checklist Patient', category: 'Sleep' })}
      >
...
export default MainCategoryPatient;
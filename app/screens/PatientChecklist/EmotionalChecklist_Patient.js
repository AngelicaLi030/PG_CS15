...
import styles from '../../styles/PatientChecklistStyles/EmotionalChecklistStyle_Patient';
import { useNavigation } from '@react-navigation/native';

const EmotionalChecklist_Patient = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text testID="title" style={styles.title}>Social or emotional</Text>
...
export default EmotionalChecklist_Patient;
